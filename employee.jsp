...
font-size: 16px;">  <a href="Home.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
      ...
      if("valid".equals(msg))
      {
    	 ...
    	 message="Registered  Successfully with EmployeeID=" +i1+"";
      ...
      <%} 
      %>
                     <form action="saveemployee.jsp" method="post" id="fileForm" role="form">
            <fieldset><legend class="text-center">EMPLOYEE  <span class="req"><small> </small></span></legend>
