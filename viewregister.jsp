...
font-size: 16px;">  <a href="Home.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <h4><font color="Orange">REGISTER REPORT</font></h4>
    ...
    try
    {
        ...
        %>
              ...
              <table class="table movie-table" id="collapse1">
                   ...
                   <th><font color="Red">REGISTERID</font></th>
                      <th><font color="Red">NAME</font></th>
                  
                     <th><font color="Red">EAMIL</font></th>
                       <th><font color="Red">MOBILE</font></th>
                    <th><font color="Red">PASSWORD</font></th>
                   
                      <th><font color="Red">REGISTERDATE</font></th>
      ...
      String i;
        while(rs.next())
        {
       	 ...
       	 <tr>
       	        ...
       	        <td size="10px"><font color="Black"><%=rs.getString(1)%></font></td>      	
