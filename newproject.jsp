...
font-size: 16px;">  <a href="Home.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
      ...
      if("valid".equals(msg))
      {
    	 ...
    	 message="Registered  Successfully with ProjectID=" +i1+"";
      ...
      <%} 
      %>
                     <form action="saveproject.jsp" method="post" id="fileForm" role="form">
            ...
            <div class="form-group"> 	 
                <label for="pname"><span class="req">* </span> Project Name: </label>
                    <input class="form-control" type="text" name="pname" id = "txt" onkeyup = "Validate(this)" required value="${message1}" /> 
                        <div id="errFirst"></div>    
            </div>
            ...
            <div class="form-group">
                <label for="vname"><span class="req">* </span> Vendor Name: </label> 
                    <input class="form-control" required type="text" name="vname" id = "vname"  onkeyup = "Validate(this)" value="${message2}"/>   
            ...
            <label for="sdate"><span class="req">* </span> Start Date: </label>
                    <input required type="date" name="sdate" id="jdate" class="form-control" value="${message4}"/> 
            </div>
             <div class="form-group">
            <label for="edate"><span class="req">* </span> End Date: </label>
                    <input required type="date" name="edate" id="jdate" class="form-control" value="${message5}" /> 
            </div>
             <div class="form-group">
                <label for="dur"><span class="req">* </span> Duration: </label> 
                    <input class="form-control" required type="text" name="dur" id = "dur"  value="${message6}" />   
                        <div class="status" id="status"></div>
            </div>
              <div class="form-group">
                <label for="mname"><span class="req">* </span> Manager Name: </label> 
                    <input class="form-control" required type="text" name="mname" id = "mname"  onkeyup = "Validate(this)" value="${message8}"/>   
                        <div class="status" id="status"></div>
            </div>
              <div class="form-group">
            <label for="pdate"><span class="req">* </span> Project Date: </label>
                    <input required type="date" name="pdate" id="pdate" class="form-control" value="${message7}"/> 
            </div>
            <div class="form-group">
