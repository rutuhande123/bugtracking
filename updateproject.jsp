...
font-size: 16px;">  <a href="Home.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
               ...
               <p>${message}</p>
        <h4><font color="Orange">UPDATE PROJECT</font></h4>
    ...
    try
    {
        ...
        %>
              ...
              <table class="table movie-table" id="collapse1">
                   ...
                   <th><font color="Red">PROJECTID</font></th>
                      <th><font color="Red">NAME</font></th>
                  
                     <th><font color="Red">VENDOR</font></th>
                   
                
                     <th><font color="Red">TECHNOLOGY</font></th>
                      <th><font color="Red">STARTDATE</font></th>
                    <th><font color="Red">ENDDATE</font></th>
                     <th><font color="Red">DURATION</font></th>
                      <th><font color="Red">REGISTEREDDATE</font></th>
      ...
      String i;
        while(rs.next())
        {
       	 ...
       	 <tr>
       	      ...
       	      <td size="2px"><font color="Red"></font><A href="./updateproject1.jsp?bid=<%=i%>"><font color="Red">UPDATE</font>&nbsp;&nbsp;<%=i%></A></td>   
